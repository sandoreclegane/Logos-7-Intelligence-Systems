    ...
    <main>
      ...
      >
        <div className="section-inner" style={{ width: '100%' }}>
          ...
          <p className="motto">The Work</p>
          <h1 style={{ fontSize: 'clamp(2.2rem, 4vw, 3.6rem)' }}>
            Tools built on<br />the framework.
          </h1>
          <p className="subtitle">
            Each project here is an application of the Logos 7 principle — technology
      ...
      <section className="section-stone" style={{ padding: '5rem 3rem' }}>
        <div className="section-inner">
          <div className="card">
            <h3>Build Within the Framework</h3>
            <p>
              ...
              this cooperative — something that serves people rather than extracting
              from them — the Licensed Practitioner Program is how you do it with
      ...
      <footer>
        <p>Logos 7 © 2026 · A Human-AI Cooperative</p>
